...
if __name__ == '__main__':
    ...
    mix_step = st.sidebar.slider('How much style you want to mix', 0, 6, 3, 1)
    image = style_mixing(opt, seed=random_seed, domain=domain, n_source=n_source, n_target=n_target,
                         mixing_range=(0, mix_step))
